...
LC_WQ1 <- read.csv("data/raw/LC_WQ1_All_Days_R.csv", header= T)
LC_WQ3 <- read.csv("data/raw/LC_WQ3_All_Days_R.csv", header= T)
LC_WQ2 <- read.csv("data/raw/LC_WQ2_All_Days_R.csv", header= T)
LC_WQ4 <- read.csv("data/raw/LC_WQ4_All_Days_R.csv", header= T)
LC_WQ5 <- read.csv("data/raw/LC_WQ5_All_Days_R.csv", header= T)
LC_WQ6 <- read.csv("data/raw/LC_WQ6_All_Days_R.csv", header= T)
LC_WQ7 <- read.csv("data/raw/LC_WQ7_All_Days_R.csv", header= T)
LC_WQ8 <- read.csv("data/raw/LC_WQ8_All_Days_R.csv", header= T)
LC_WQ9 <- read.csv("data/raw/LC_WQ9_All_Days_R.csv", header= T)
...
write.csv(Data, "data/full-data.csv")
